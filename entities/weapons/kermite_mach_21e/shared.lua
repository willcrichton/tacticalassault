...
SWEP.ViewModel				= "models/weapons/v_mach_hk21eswp.mdl"
SWEP.WorldModel				= "models/weapons/w_mach_hk21eswp.mdl"

SWEP.Primary.Sound			= Sound("weapons/21e/21.wav")
...
SWEP.IronSightsPos = Vector (-3.4255, -1.9041, 1.8248)
SWEP.IronSightsAng = Vector (-0.1572, -0.0106, 0)
