...
if ( CLIENT ) then
	SWEP.PrintName			= "Hibben Scorpion"	
	SWEP.Author				= "Kermite"
	SWEP.DrawAmmo 			= false
...
SWEP.ViewModel 				= "models/weapons/v_knife_h.mdl"
SWEP.WorldModel 			= "models/weapons/w_knife_h.mdl" 
...
SWEP.IronSightsPos = Vector (1.3802, -5.7766, -3.7185)
SWEP.IronSightsAng = Vector (31.8159, -10.86, -0.0532)
...
function SWEP:SecondaryAttack()
	...
	if SERVER then
		local knife = ents.Create("ent_hibb")
