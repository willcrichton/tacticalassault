...
if (CLIENT) then
	SWEP.PrintName 		= "Dual Skif A-3000"
...
SWEP.ViewModel				= "models/weapons/v_pist_duale.mdl"
SWEP.WorldModel				= "models/weapons/w_pist_duale.mdl"
SWEP.Category			= "Kermite's Pistols Weapons"
SWEP.Primary.Sound 		= Sound("weapons/duale/elite-1.wav")
SWEP.Primary.Damage 		= 5
SWEP.Primary.Recoil 		= 0.15
SWEP.Primary.NumShots 		= 1
SWEP.Primary.Cone 		= 0.007
SWEP.Primary.ClipSize 		= 56
