...
SWEP.ViewModel 			= "models/weapons/v_shot_remmin870.mdl"
SWEP.WorldModel 		= "models/weapons/w_shot_remmin870.mdl"

SWEP.Primary.Sound 		= Sound("weapons/remington870/m3-1.wav")
...
SWEP.IronSightsPos = Vector (3.7005, -1.8862, 2.3071)
SWEP.IronSightsAng = Vector (1.3493, 0.0648, -3.6769)
...
function SWEP:Think()
	...
	if self.Weapon:GetNetworkedBool( "reloading") == true then
		...
		self.Weapon:EmitSound("weapons/remington870/m3_pump.wav")
	...
	self.Weapon:EmitSound("weapons/remington870/m3_insertshell.wav")
