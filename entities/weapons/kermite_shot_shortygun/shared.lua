...
SWEP.Primary.Sound 		= Sound("weapons/shorty/m3-2.wav")
...
SWEP.IronSightsPos = Vector (4.2129, 0, 1.7163)
SWEP.IronSightsAng = Vector (2.9233, -0.313, 0)
...
SWEP.data.burst.Cone 		= 0.085
SWEP.data.burst.NumShots 	= 12
SWEP.data.burst.Damage 		= 6.5
...
self.Weapon:EmitSound("weapons/shorty/m3_pump.wav")
...
function SWEP:Think()
	...
	self.Weapon:EmitSound("weapons/shorty/m3_insertshell.wav")
