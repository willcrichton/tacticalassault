...
concommand.Add("techie_manhacks",function(pl)
	...
	if CurTime() - last < TIME_MANHACKS && last != 0 then pl:ChatPrint("You have "..tostring(TIME_MANHACKS - CurTime() - last).." more seconds til your next manhack strike.") return end
...
concommand.Add("techie_turret",function(pl)
	...
	if CurTime() - last < TIME_TURRET && last != 0 then pl:ChatPrint("You have "..tostring(TIME_TURRET - CurTime() - last).." more seconds before spawning another turret.") return end
